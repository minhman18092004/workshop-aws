...
* Validate the GitOps flow and the final deployment.
* Close the project with a stable configuration ready for the report.

### Tasks to be carried out this week:
| Day | Task | Start Date | Completion Date | Reference Material |
| --- | --- | --- | --- | --- |
| 2   | - Enable the Spring Boot Actuator Prometheus endpoint and export application metrics.<br>- Confirm that the backend is ready for the monitoring system to scrape. | 07/07/2026 | 07/07/2026 | content/1-Worklog/1.12-Week12/ |
...
* Deployed Prometheus and Grafana for system monitoring.
* Verified the final deployment consistency through GitOps checks.
* Completed the project timeline with the final review before the report.
