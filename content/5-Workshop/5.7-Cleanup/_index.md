...
![RDS Database Deletion Confirmation](/images/5-Workshop/5.6-Cleanup/rds_delete_confirm.png)
![RDS Database Deleting Status](/images/5-Workshop/5.6-Cleanup/rds_delete.png)
...
2. For each bucket (`novatech-product-images` and `novatech-chatbot-rag`):
   ...
   - Type `permanently delete` to acknowledge emptying objects.
     ...
     ![Confirm Emptying S3 Bucket](/images/5-Workshop/5.6-Cleanup/s3_empty_confirm.png)
     ![S3 Bucket Emptied Successfully](/images/5-Workshop/5.6-Cleanup/s3_empty_success.png)

   - Return to the Buckets list, select the bucket, and click **Delete**.
   - Enter the name of the bucket to confirm permanent deletion.

     ![Confirm S3 Bucket Deletion](/images/5-Workshop/5.6-Cleanup/s3_delete_confirm.png)
     ![S3 Bucket Deleted Successfully](/images/5-Workshop/5.6-Cleanup/s3_delete_success.png)
...
3. Click **Delete user pool** in the top right corner and follow the instructions to confirm deletion.
   ...
   ![Confirm Cognito User Pool Deletion](/images/5-Workshop/5.6-Cleanup/cognito_delete_confirm.png)
   ![Cognito User Pool Deleted Successfully](/images/5-Workshop/5.6-Cleanup/cognito_delete_success.png)
...
3. Click the **Disable** button and confirm to take the distribution offline:
   ...
   ![Disable CloudFront Distribution](/images/5-Workshop/5.6-Cleanup/cloudfront_disable_distribution.png)

4. Once the distribution status is successfully disabled, you will see a notification indicating it can be deleted:

   ![Distribution Disabled Status](/images/5-Workshop/5.6-Cleanup/cloudfront_disabled_status.png)

5. Select the distribution, click **Delete**, and confirm on the popup to permanently delete it:

   ![Confirm CloudFront Distribution Deletion](/images/5-Workshop/5.6-Cleanup/cloudfront_delete_distribution_confirm.png)
   ![CloudFront Distribution Deleted Successfully](/images/5-Workshop/5.6-Cleanup/cognito_delete_success.png)
